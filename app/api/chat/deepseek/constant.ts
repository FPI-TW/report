...
export const PARAMS_PROMPT =
  "reportType(如果未提供，設為daily report), reportDate(如果未提供，設為今天的日期，格式為YYYY-MM-DD)，pdfText(如果提供了PDF文字內容，請參考並整合分析，並在回答中適當引用相關內容，以支持你的分析結論。請確保引用的內容準確無誤，並與分析結論相關聯。如果沒有提供PDF內容，則忽略此項。)。"
